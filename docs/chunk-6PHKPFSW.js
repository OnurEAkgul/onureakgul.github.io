...
var MailService = class _MailService {
  ...
  get isConfigured() {
    return !emailJsConfig.publicKey.startsWith("REPLACE_") && !emailJsConfig.serviceId.startsWith("REPLACE_") && !emailJsConfig.templateId.startsWith("REPLACE_");
  }
  sendContact(payload) {
    return __async(this, null, function* () {
      ...
      return es_default.send(emailJsConfig.serviceId, emailJsConfig.templateId, {
        from_name: payload.name || "Portfolio visitor",
        from_email: payload.replyEmail || "",
        subject: payload.subject || "Portfolio contact",
        message: payload.message,
        to_email: "onurerenakgul@gmail.com"
      }, { publicKey: emailJsConfig.publicKey });
    });
  }
  static \u0275fac = function MailService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MailService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _MailService, factory: _MailService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MailService, [{
    type: Injectable,
...
function ContactComponent_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275classProp("ok", ctx_r0.status === "success")("err", ctx_r0.status === "error");
    \u0275\u0275advance();
...
var ContactComponent = class _ContactComponent {
  ...
  sendMessage() {
    return __async(this, null, function* () {
      if (!this.subject.trim() || !this.message.trim()) {
        this.status = "error";
        this.statusMessage = this.ui().contact.missingFields;
        return;
      }
      this.sending = true;
      this.status = "idle";
      ...
      try {
        ...
        this.status = "success";
        this.statusMessage = this.ui().contact.success;
        this.clear(false);
      } catch {
        this.status = "error";
        this.statusMessage = this.ui().contact.error;
      } finally {
        this.sending = false;
      }
    });
  }
  clear(resetStatus = true) {
    this.name = "";
    this.replyEmail = "";
    this.subject = "";
    this.message = "";
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactComponent, selectors: [["app-contact"]], decls: 27, vars: 17, consts: [[1, "page"], [1, "page-header"], [1, "form", 3, "ngSubmit"], ["pInputText", "", "name", "name", "autocomplete", "name", 3, "ngModelChange", "ngModel"], ["pInputText", "", "type", "email", "name", "replyEmail", "autocomplete", "email", 3, "ngModelChange", "ngModel"], [1, "full"], ["pInputText", "", "name", "subject", 3, "ngModelChange", "ngModel"], ["pTextarea", "", "name", "message", "rows", "6", 3, "ngModelChange", "ngModel"], [1, "status", 3, "ok", "err"], [1, "actions"], ["type", "button", 3, "onClick", "label", "outlined", "disabled"], ["type", "submit", "icon", "pi pi-send", 3, "label", "loading", "disabled"], [1, "status"]], template: function ContactComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("ngSubmit", function ContactComponent_Template_form_ngSubmit_6_listener() {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Template_input_ngModelChange_10_listener($event) {
      ...
      \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Template_input_ngModelChange_14_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.replyEmail, $event) || (ctx.replyEmail = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Template_input_ngModelChange_18_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.subject, $event) || (ctx.subject = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(19, "label", 5)(20, "span");
      \u0275\u0275text(21);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "textarea", 7);
      \u0275\u0275twoWayListener("ngModelChange", function ContactComponent_Template_textarea_ngModelChange_22_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.message, $event) || (ctx.message = $event);
        return $event;
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(23, ContactComponent_Conditional_23_Template, 2, 5, "p", 8);
      \u0275\u0275elementStart(24, "div", 9)(25, "p-button", 10);
      \u0275\u0275listener("onClick", function ContactComponent_Template_p_button_onClick_25_listener() {
        return ctx.clear();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275element(26, "p-button", 11);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.ui().contact.title);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.ui().contact.subtitle);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.ui().contact.name);
      \u0275\u0275advance();
      \u0275\u0275twoWayProperty("ngModel", ctx.name);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.ui().contact.email);
      \u0275\u0275advance();
      \u0275\u0275twoWayProperty("ngModel", ctx.replyEmail);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.ui().contact.subject);
      \u0275\u0275advance();
      \u0275\u0275twoWayProperty("ngModel", ctx.subject);
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.ui().contact.message);
      \u0275\u0275advance();
      \u0275\u0275twoWayProperty("ngModel", ctx.message);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.statusMessage ? 23 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("label", ctx.ui().contact.clear)("outlined", true)("disabled", ctx.sending);
      \u0275\u0275advance();
      \u0275\u0275property("label", ctx.sending ? ctx.ui().contact.sending : ctx.ui().contact.send)("loading", ctx.sending)("disabled", ctx.sending);
    }
  }, dependencies: [FormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm, Button, InputText, Textarea], styles: ["\n\n.page-header[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  font-family: var(--font-display);\n  font-size: clamp(2rem, 5vw, 3.2rem);\n  margin: 0 0 0.5rem;\n  letter-spacing: -0.03em;\n}\n.page-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  color: var(--muted);\n  margin: 0 0 1.75rem;\n  max-width: 40rem;\n  line-height: 1.6;\n}\n.form[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 1rem;\n  background: var(--bg-elevated);\n  border: 1px solid var(--line);\n  border-radius: 1.1rem;\n  padding: 1.4rem;\n}\nlabel[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 0.45rem;\n}\nlabel[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: var(--ink-soft);\n  font-size: 0.92rem;\n}\ninput[_ngcontent-%COMP%], \ntextarea[_ngcontent-%COMP%] {\n  width: 100%;\n}\n.status[_ngcontent-%COMP%] {\n  margin: 0;\n  font-weight: 600;\n}\n.status.ok[_ngcontent-%COMP%] {\n  color: var(--accent);\n}\n.status.err[_ngcontent-%COMP%] {\n  color: #b42318;\n}\n.actions[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.7rem;\n  flex-wrap: wrap;\n}\n@media (min-width: 720px) {\n  .form[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr 1fr;\n  }\n  .full[_ngcontent-%COMP%], \n   .status[_ngcontent-%COMP%], \n   .actions[_ngcontent-%COMP%] {\n    grid-column: 1 / -1;\n  }\n}\n/*# sourceMappingURL=contact.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ContactComponent, [{
    type: Component,
    args: [{ selector: "app-contact", imports: [FormsModule, Button, InputText, Textarea], template: `
    <section class="page">
      ...
      <form class="form" (ngSubmit)="sendMessage()">
        <label>
          <span>{{ ui().contact.name }}</span>
          <input pInputText name="name" [(ngModel)]="name" autocomplete="name" />
        </label>
        ...
        <label class="full">
          <span>{{ ui().contact.subject }}</span>
          <input pInputText name="subject" [(ngModel)]="subject" />
        </label>

        <label class="full">
          <span>{{ ui().contact.message }}</span>
          <textarea pTextarea name="message" rows="6" [(ngModel)]="message"></textarea>
        </label>

        @if (statusMessage) {
          <p class="status" [class.ok]="status === 'success'" [class.err]="status === 'error'">
            {{ statusMessage }}
          </p>
        }
  ...
  `, styles: ["/* angular:styles/component:css;7b6fbbf1d5ed6a03b3b23db41f98adc9b3df1a90c94f7644c9b30f0d8e10225f;C:/Projeler/onureakgul.github.io/src/app/pages/contact.component.ts */\n.page-header h1 {\n  font-family: var(--font-display);\n  font-size: clamp(2rem, 5vw, 3.2rem);\n  margin: 0 0 0.5rem;\n  letter-spacing: -0.03em;\n}\n.page-header p {\n  color: var(--muted);\n  margin: 0 0 1.75rem;\n  max-width: 40rem;\n  line-height: 1.6;\n}\n.form {\n  display: grid;\n  gap: 1rem;\n  background: var(--bg-elevated);\n  border: 1px solid var(--line);\n  border-radius: 1.1rem;\n  padding: 1.4rem;\n}\nlabel {\n  display: grid;\n  gap: 0.45rem;\n}\nlabel span {\n  font-weight: 600;\n  color: var(--ink-soft);\n  font-size: 0.92rem;\n}\ninput,\ntextarea {\n  width: 100%;\n}\n.status {\n  margin: 0;\n  font-weight: 600;\n}\n.status.ok {\n  color: var(--accent);\n}\n.status.err {\n  color: #b42318;\n}\n.actions {\n  display: flex;\n  justify-content: flex-end;\n  gap: 0.7rem;\n  flex-wrap: wrap;\n}\n@media (min-width: 720px) {\n  .form {\n    grid-template-columns: 1fr 1fr;\n  }\n  .full,\n  .status,\n  .actions {\n    grid-column: 1 / -1;\n  }\n}\n/*# sourceMappingURL=contact.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactComponent, { className: "ContactComponent", filePath: "src/app/pages/contact.component.ts", lineNumber: 145 });
})();
export {
  ContactComponent
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-6PHKPFSW.js.map
