...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-2SDVMVUY.js").then((m5) => m5);
    ...
    return moduleImplPromise.catch((e67) => {
...
var t = { color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{text.color}", activeHoverColor: "{text.color}", padding: "1rem", fontWeight: "600", fontSize: "{typography.font.size}", borderRadius: "0", borderWidth: "0", borderColor: "{content.border.color}", background: "{content.background}", hoverBackground: "{content.background}", activeBackground: "{content.background}", activeHoverBackground: "{content.background}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "-1px", shadow: "{focus.ring.shadow}" }, toggleIcon: { color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{text.color}", activeHoverColor: "{text.color}" }, first: { topBorderRadius: "{content.border.radius}", borderWidth: "0" }, last: { bottomBorderRadius: "{content.border.radius}", activeBottomBorderRadius: "0" } };
...
var t2 = { width: "2.625rem", height: "2.625rem", fontSize: "1.25rem", icon: { size: "1.25rem" }, group: { offset: "-0.875rem" } };
var i2 = { width: "3.5rem", height: "3.5rem", fontSize: "1.75rem", icon: { size: "1.75rem" }, group: { offset: "-1.25rem" } };
var n = { root: e3, icon: o3, group: r3, lg: t2, xl: i2 };
...
var t3 = { background: "light-dark({surface.100}, {surface.800})", color: "light-dark({surface.600}, {surface.300})" };
...
var l2 = { root: r4, dot: e4, sm: a, lg: o4, xl: d2, primary: i3, secondary: t3, success: c3, info: g, warn: n2, danger: s2, contrast: h };
...
var t4 = { color: "{navigation.item.icon.color}" };
var n3 = { root: o6, item: i4, separator: t4 };
...
var t6 = { root: r9, content: o9, indicatorList: i5, indicator: a5 };
...
var s3 = { root: r12, image: o12, icon: e10, label: a6, removeIcon: i7 };
...
var s4 = { root: r13, preview: o13, panel: e11, handle: a7 };
...
var t7 = { padding: "0.625rem 1.125rem", background: "{content.background}", borderColor: "{content.border.color}" };
var c4 = { root: o14, header: r14, input: e12, list: d5, empty: n5, footer: t7 };
...
var t8 = { color: "{content.color}", fontWeight: "{typography.font.weight}", fontSize: "{typography.font.size}" };
var r16 = { icon: o16, content: e14, message: t8 };
...
var t9 = { padding: "{navigation.submenu.label.padding}", fontWeight: "{navigation.submenu.label.font.weight}", fontSize: "{navigation.submenu.label.font.size}", background: "{navigation.submenu.label.background}", color: "{navigation.submenu.label.color}" };
...
var c5 = { root: o18, list: i8, item: n7, submenu: a9, submenuLabel: t9, submenuIcon: e16, separator: r18 };
...
var t10 = { fontWeight: "600", fontSize: "{typography.font.size}" };
...
var k = { root: o19, header: r19, headerCell: e17, columnTitle: t10, row: d7, bodyCell: c6, footerCell: l4, columnFooter: n8, footer: a11, dropPoint: i9, columnResizer: s5, resizeIndicator: g2, sortIcon: p2, loadingIcon: u, rowToggleButton: b, filter: m, paginatorTop: h2, paginatorBottom: f3, css };
...
var t11 = { borderColor: "{content.border.color}", borderWidth: "0 0 1px 0" };
var n9 = { borderColor: "{content.border.color}", borderWidth: "1px 0 0 0" };
var c7 = { root: o20, header: r20, content: d8, footer: e18, paginatorTop: t11, paginatorBottom: n9 };
...
var t12 = { gap: "0.5rem", fontWeight: "500", fontSize: "{typography.font.size}" };
...
var k2 = { root: o21, panel: r21, header: e19, title: t12, dropdown: n10, inputIcon: d9, selectMonth: c8, selectYear: a12, group: i10, dayView: l5, weekDay: g3, date: s6, monthView: f4, month: h3, yearView: u2, year: p3, buttonbar: b2, timePicker: m2, today: y };
...
var t13 = { root: r23, content: o23, horizontal: n11, vertical: e21 };
...
var t14 = { focusBackground: "{list.option.focus.background}", color: "{list.option.color}", focusColor: "{list.option.focus.color}", padding: "{list.option.padding}", borderRadius: "{list.option.border.radius}" };
...
var l8 = { toolbar: o26, toolbarItem: r26, overlay: e23, overlayOption: t14, content: d13 };
...
var t15 = { color: "{text.muted.color}", hoverColor: "{text.hover.muted.color}" };
var n12 = { padding: "0" };
var e24 = { root: o27, legend: r27, toggleIcon: t15, content: n12 };
...
var t16 = { padding: "0.875rem", gap: "0.875rem", borderColor: "{content.border.color}", info: { gap: "0.125rem" } };
...
var g4 = { gap: "0.5rem" };
var c9 = { root: r28, header: o28, content: e25, file: t16, fileName: n13, fileSize: a15, fileList: i11, progressbar: d14, basic: g4 };
...
var f6 = { size: "1.25rem" };
var l9 = { root: r30, navButton: o30, navIcon: e27, thumbnailsContent: s7, thumbnailNavButton: a16, thumbnailNavButtonIcon: t17, caption: c10, indicatorList: n14, indicatorButton: i13, insetIndicatorList: u3, insetIndicatorButton: d15, closeButton: g5, closeButtonIcon: f6 };
...
var t18 = { size: "5rem", padding: "0.25rem", background: "{surface.800}", borderRadius: "0.25rem", borderWidth: "3px", hoverBorderColor: "{surface.700}", activeBorderColor: "{primary.color}", activeScale: "0.85", transitionDuration: "{transition.duration}" };
var d16 = { padding: "0.25rem 0" };
var s8 = { backdrop: r31, header: o31, footer: a17, item: e28, action: i14, navigation: n15, thumbnail: t18, thumbnailContent: d16 };
...
var t19 = { background: "light-dark({surface.900}, {surface.0})", borderColor: "light-dark({surface.950}, {surface.100})", color: "light-dark({surface.50}, {surface.950})", shadow: "0px 4px 8px 0px color-mix(in srgb, {surface.950}, transparent 96%)" };
var d17 = { root: r35, text: o36, icon: a19, info: e30, success: n16, warn: l11, error: i17, secondary: s9, contrast: t19 };
...
var t20 = { color: "{surface.100}", background: "#ffffff", tileSize: "0.5rem" };
var i18 = { size: "2.25rem", borderRadius: "{content.border.radius}" };
var a20 = { root: r38, area: o39, slider: e31, handle: d19, transparencyGrid: t20, swatch: i18 };
...
var r41 = { gap: "0.5rem" };
var t21 = { width: "2.25rem", sm: { width: "1.75rem" }, lg: { width: "2.625rem" } };
var e32 = { root: r41, input: t21 };
...
var t22 = { background: "{content.border.color}" };
var n18 = { color: "{text.muted.color}", fontSize: "1.125rem", fontWeight: "normal" };
var i19 = { root: o44, value: r43, range: t22, text: n18 };

// node_modules/@primeuix/themes/dist/aura/label/index.mjs
var t23 = { gap: "0.375rem", fontSize: "{typography.font.size}", fontWeight: "500", textColor: "{text.color}", disabledOpacity: "{disabled.opacity}" };
var o45 = { root: t23 };
...
var t24 = { fontWeight: "{list.option.font.weight}", fontSize: "{list.option.font.size}", focusBackground: "{list.option.focus.background}", selectedBackground: "{list.option.selected.background}", selectedFocusBackground: "{list.option.selected.focus.background}", color: "{list.option.color}", focusColor: "{list.option.focus.color}", selectedColor: "{list.option.selected.color}", selectedFocusColor: "{list.option.selected.focus.color}", selectedFontWeight: "{list.option.selected.font.weight}", padding: "{list.option.padding}", borderRadius: "{list.option.border.radius}", stripedBackground: "light-dark({surface.50}, {surface.900})" };
...
var l12 = { root: o46, list: i20, option: t24, optionGroup: r44, checkmark: d22, emptyMessage: e33 };
...
var t25 = { padding: "{navigation.list.padding}", gap: "{navigation.list.gap}" };
...
var d23 = { root: o47, baseItem: n19, item: i21, overlay: a22, submenu: t25, submenuLabel: e34, submenuIcon: r45, separator: c11, mobileButton: g6 };
...
var t26 = { size: "{navigation.submenu.icon.size}", color: "{navigation.submenu.icon.color}", focusColor: "{navigation.submenu.icon.focus.color}" };
var e35 = { borderColor: "{content.border.color}" };
var r46 = { root: o48, list: n20, item: i22, submenuLabel: a23, submenuIcon: t26, separator: e35 };
...
var t27 = { borderColor: "{content.border.color}" };
...
var e36 = { root: o49, baseItem: i23, item: n21, submenu: a24, separator: t27, mobileButton: r47 };
...
var b3 = { root: r48, content: o50, text: e37, icon: l13, closeButton: a25, closeIcon: n22, outlined: t28, simple: i24, info: s10, success: d24, warn: g7, error: c12, secondary: u4, contrast: h4 };
...
var t29 = { fontWeight: "{typography.font.weight}", fontSize: "{typography.font.size}" };
var l14 = { size: "0.875rem" };
var i25 = { verticalGap: "0.375rem", horizontalGap: "0.875rem" };
var n23 = { root: e38, meters: r49, label: a26, labelMarker: o51, labelText: t29, labelIcon: l14, labelList: i25 };
...
var t30 = { padding: "{list.option.padding}" };
var a27 = { root: o52, dropdown: r50, overlay: d25, list: i26, option: e39, optionGroup: l15, chip: n24, clearIcon: f7, emptyMessage: t30 };
...
var t31 = { color: "{content.border.color}", borderRadius: "{content.border.radius}", height: "24px" };
var n25 = { root: o55, node: r52, nodeToggleButton: e40, connector: t31 };
...
var t34 = { fontWeight: "600", fontSize: "{typography.font.size}" };
var d26 = { padding: "0 1rem 1rem 1rem" };
var n27 = { padding: "0 1rem 1rem 1rem" };
var a30 = { root: r54, header: o58, toggleableHeader: e42, title: t34, content: d26, footer: n27 };
...
var r55 = { indent: "1rem" };
var t35 = { color: "{navigation.submenu.icon.color}", focusColor: "{navigation.submenu.icon.focus.color}" };
var a31 = { root: o59, panel: i28, item: n28, submenu: r55, submenuIcon: t35 };
...
var t36 = { weakBackground: "light-dark({red.500}, {red.400})", mediumBackground: "light-dark({amber.500}, {amber.400})", strongBackground: "light-dark({green.500}, {green.400})" };
var n29 = { meter: o60, icon: r56, overlay: e43, content: a32, meterText: d27, strength: t36 };
...
var t37 = { root: r59, value: o63, label: e45 };
...
var t38 = { background: "{content.border.color}" };
var e48 = { fadeSize: "40px" };
var a35 = { root: o66, viewport: r64, scrollbar: n30, handle: t38, mask: e48 };
...
var t39 = { color: "{list.option.color}", gutterStart: "-0.25rem", gutterEnd: "0.25rem" };
var n31 = { padding: "{list.option.padding}" };
var c13 = { root: o68, dropdown: r66, overlay: d28, list: i30, option: e49, optionGroup: l16, clearIcon: f8, checkmark: t39, emptyMessage: n31 };
...
var p4 = { root: o70, layout: i31, header: n32, footer: r68, content: a36, aside: t40, panel: e50, group: c14, groupLabel: g8, groupAction: d29, menu: u5, menuButton: m3, menuAction: s12, menuBadge: l17, menuSub: f9, menuSubButton: v, main: b4 };
...
var a38 = { root: o71, track: r70, range: n33, handle: t41 };

// node_modules/@primeuix/themes/dist/aura/speeddial/index.mjs
var t42 = { gap: "0.5rem", transitionDuration: "{transition.duration}" };
var a39 = { root: t42 };
...
var t43 = { root: o72, gutter: r72, handle: n34 };
...
var t44 = { padding: "0", borderRadius: "{content.border.radius}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" }, gap: "0.5rem" };
...
var d31 = { root: o73, separator: r73, step: e51, stepHeader: t44, stepTitle: n35, stepNumber: a40, steppanels: c15, steppanel: i32 };
...
var t45 = { borderRadius: "{content.border.radius}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" }, gap: "0.5rem" };
...
var c16 = { root: o74, separator: r74, itemLink: t45, itemLabel: e52, itemNumber: n36 };
...
var n37 = { root: o75, tablist: r75, item: t46, itemIcon: e53, activeBar: c17 };
...
var t47 = { background: "transparent", hoverBackground: "transparent", activeBackground: "transparent", borderWidth: "0", borderColor: "transparent", hoverBorderColor: "transparent", activeBorderColor: "transparent", color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{primary.color}", padding: "0.875rem 1rem", fontWeight: "600", fontSize: "{typography.font.size}", margin: "0", gap: "0.5rem", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "-1px", shadow: "{focus.ring.shadow}" } };
...
var c18 = { root: o76, tablist: r76, tab: t47, tabpanel: n38, navButton: e54, activeBar: a41 };
...
var t48 = { borderColor: "{content.border.color}", activeBorderColor: "{primary.color}", color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{primary.color}" };
...
var a42 = { root: o77, tabList: r77, tab: t48, tabPanel: n39, navButton: c19 };
...
var t49 = { background: "light-dark({surface.950}, {surface.0})", color: "light-dark({surface.0}, {surface.950})" };
var c20 = { root: r78, icon: a43, primary: o78, secondary: e55, success: n40, info: d32, warn: i33, danger: g9, contrast: t49 };
...
var t50 = { size: "{navigation.submenu.icon.size}", color: "{navigation.submenu.icon.color}", focusColor: "{navigation.submenu.icon.focus.color}", activeColor: "{navigation.submenu.icon.active.color}" };
var e57 = { borderColor: "{content.border.color}" };
var r80 = { root: o81, list: i34, item: n41, submenu: a44, submenuIcon: t50, separator: e57 };
...
var t51 = { color: "{content.border.color}", size: "2px" };
var d35 = { event: e58, horizontal: r81, vertical: o82, eventMarker: n42, eventConnector: t51 };
...
var t52 = { fontWeight: "500", fontSize: "0.75rem" };
...
var p5 = { root: r82, icon: o83, content: e59, text: a45, summary: n43, detail: t52, closeButton: l18, closeIcon: s13, normal: c21, info: i35, success: d36, warn: g10, error: u6, secondary: h5, contrast: f10 };
...
var t53 = { fontWeight: "{typography.font.weight}", selectedFontWeight: "{list.option.selected.font.weight}", fontSize: "{typography.font.size}" };
...
var l19 = { root: o88, node: e62, nodeIcon: r87, nodeLabel: t53, nodeToggleButton: n44, loadingIcon: c22, filter: d38, css: css2 };
...
var t54 = { fontWeight: "600", fontSize: "{typography.font.size}" };
...
var p6 = { root: o90, header: r89, headerCell: e64, columnTitle: t54, row: c23, bodyCell: n45, footerCell: d40, columnFooter: l21, footer: a47, columnResizer: i37, resizeIndicator: g11, sortIcon: s14, loadingIcon: h6, nodeToggleButton: u7, paginatorTop: b5, paginatorBottom: f12, css: css3 };
...
var t55 = Object.prototype.hasOwnProperty;
...
var Zr;
var $r = (Zr = ((r91, e67) => {
  for (var m5 in e67 || (e67 = {})) t55.call(e67, m5) && o92(r91, m5, e67[m5]);
  if (i38) for (var m5 of i38(e67)) a48.call(e67, m5) && o92(r91, m5, e67[m5]);
  return r91;
})({}, a2), e66(Zr, m4({ components: { accordion: c, autocomplete: s, avatar: n, badge: l2, blockui: o5, breadcrumb: n3, button: d3, card: n4, carousel: t6, cascadeselect: f2, checkbox: e9, chip: s3, colorpicker: s4, commandmenu: c4, compare: n6, confirmdialog: r16, confirmpopup: d6, contextmenu: c5, datatable: k, dataview: c7, datepicker: k2, dialog: e20, divider: t13, dock: d11, drawer: e22, editor: l8, fieldset: e24, fileupload: c9, floatlabel: f5, galleria: l9, gallery: s8, iconfield: r32, iftalabel: l10, image: e29, imagecompare: r34, inlinemessage: d17, inplace: n17, inputchips: d18, inputcolor: a20, inputgroup: r39, inputnumber: a21, inputotp: e32, inputtags: d20, inputtext: d21, knob: i19, label: o45, listbox: l12, megamenu: d23, menu: r46, menubar: e36, message: b3, metergroup: n23, multiselect: a27, navigationmenu: o53, orderlist: o54, organizationchart: n25, overlaybadge: t32, paginator: n26, panel: a30, panelmenu: a31, password: n29, picklist: o61, popover: e44, progressbar: t37, progressspinner: e46, radiobutton: e47, rating: i29, ripple: r63, scrollarea: a35, scrollpanel: s11, select: c13, selectbutton: o69, sidebar: p4, skeleton: a37, slider: a38, speeddial: a39, splitbutton: d30, splitter: t43, stepper: d31, steps: c16, tabmenu: n37, tabs: c18, tabview: a42, tag: c20, terminal: e56, textarea: d34, tieredmenu: r80, timeline: d35, toast: p5, togglebutton: d37, toggleswitch: e61, toolbar: r85, tooltip: o87, tree: l19, treeselect: a46, treetable: p6, virtualscroller: e65 }, css: a10 })));

// src/app/guards/lang.guard.ts
var langGuard = (route) => {
...
function ShellComponent_For_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("routerLink", item_r1.link)("routerLinkActiveOptions", \u0275\u0275pureFunction1(3, _c1, item_r1.exact));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(item_r1.label);
  }
}
function ShellComponent_Conditional_12_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 13);
    \u0275\u0275listener("click", function ShellComponent_Conditional_12_For_2_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.menuOpen = false);
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
...
function ShellComponent_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "nav", 9);
    \u0275\u0275repeaterCreate(1, ShellComponent_Conditional_12_For_2_Template, 2, 2, "a", 12, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var ShellComponent = class _ShellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ShellComponent, selectors: [["app-shell"]], decls: 20, vars: 15, consts: [[1, "shell"], [1, "topbar"], [1, "brand", 3, "routerLink"], ["aria-label", "Primary", 1, "nav"], ["routerLinkActive", "active", 3, "routerLink", "routerLinkActiveOptions"], [1, "actions"], ["size", "small", 3, "onClick", "label", "text", "styleClass"], ["type", "button", 1, "menu-toggle", 3, "click"], [3, "ngClass"], ["aria-label", "Mobile", 1, "mobile-nav"], [1, "main"], [1, "footer"], [3, "routerLink"], [3, "click", "routerLink"]], template: function ShellComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "header", 1)(2, "a", 2);
      \u0275\u0275text(3);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "nav", 3);
      \u0275\u0275repeaterCreate(5, ShellComponent_For_6_Template, 2, 5, "a", 4, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "div", 5)(8, "p-button", 6);
      \u0275\u0275listener("onClick", function ShellComponent_Template_p_button_onClick_8_listener() {
        return ctx.switchLang("en");
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "p-button", 6);
      \u0275\u0275listener("onClick", function ShellComponent_Template_p_button_onClick_9_listener() {
        return ctx.switchLang("tr");
      });
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275element(11, "i", 8);
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(12, ShellComponent_Conditional_12_Template, 3, 0, "nav", 9);
      \u0275\u0275elementStart(13, "main", 10);
      \u0275\u0275element(14, "router-outlet");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "footer", 11)(16, "span");
      \u0275\u0275text(17);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(13, _c0, ctx.lang()));
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(ctx.cv().name);
      \u0275\u0275advance(2);
      \u0275\u0275repeater(ctx.navItems());
      \u0275\u0275advance(3);
      \u0275\u0275property("label", "EN")("text", true)("styleClass", ctx.lang() === "en" ? "lang-btn active-lang" : "lang-btn");
      \u0275\u0275advance();
      \u0275\u0275property("label", "TR")("text", true)("styleClass", ctx.lang() === "tr" ? "lang-btn active-lang" : "lang-btn");
      \u0275\u0275advance();
      \u0275\u0275attribute("aria-expanded", ctx.menuOpen);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", ctx.menuOpen ? "pi pi-times" : "pi pi-bars");
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.menuOpen ? 12 : -1);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(ctx.cv().name);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.ui().footer);
    }
  }, dependencies: [RouterOutlet, RouterLink, RouterLinkActive, Button, NgClass], styles: ["\n\n.shell[_ngcontent-%COMP%] {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n}\n.topbar[_ngcontent-%COMP%] {\n  position: sticky;\n  top: 0;\n  z-index: 20;\n  display: grid;\n  grid-template-columns: auto 1fr auto;\n  gap: 1rem;\n  align-items: center;\n  padding: 0.9rem clamp(1rem, 4vw, 2.5rem);\n  -webkit-backdrop-filter: blur(14px);\n  backdrop-filter: blur(14px);\n  background: color-mix(in srgb, var(--bg) 82%, transparent);\n  border-bottom: 1px solid var(--line);\n}\n.brand[_ngcontent-%COMP%] {\n  font-family: var(--font-display);\n  font-weight: 700;\n  font-size: 1.15rem;\n  letter-spacing: -0.02em;\n  color: var(--ink);\n  text-decoration: none;\n}\n.nav[_ngcontent-%COMP%] {\n  display: none;\n  justify-content: center;\n  gap: 0.35rem;\n  flex-wrap: wrap;\n}\n.nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  text-decoration: none;\n  color: var(--muted);\n  font-size: 0.92rem;\n  padding: 0.45rem 0.7rem;\n  border-radius: 999px;\n  transition: color 180ms ease, background 180ms ease;\n}\n.nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]:hover, \n.nav[_ngcontent-%COMP%]   a.active[_ngcontent-%COMP%] {\n  color: var(--ink);\n  background: var(--chip);\n}\n.actions[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.15rem;\n}\n[_nghost-%COMP%]     .lang-btn {\n  color: var(--muted) !important;\n  font-weight: 600;\n}\n[_nghost-%COMP%]     .active-lang {\n  color: var(--accent) !important;\n}\n.menu-toggle[_ngcontent-%COMP%] {\n  display: inline-flex;\n  border: 0;\n  background: transparent;\n  color: var(--ink);\n  font-size: 1.2rem;\n  margin-left: 0.35rem;\n  cursor: pointer;\n}\n.mobile-nav[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 0.35rem;\n  padding: 0.75rem 1rem 1rem;\n  border-bottom: 1px solid var(--line);\n  background: var(--bg-elevated);\n}\n.mobile-nav[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n  text-decoration: none;\n  color: var(--ink);\n  padding: 0.7rem 0.5rem;\n  border-radius: 0.6rem;\n}\n.main[_ngcontent-%COMP%] {\n  flex: 1;\n  width: min(1120px, calc(100% - 2rem));\n  margin: 0 auto;\n  padding: clamp(1.5rem, 4vw, 3rem) 0 3rem;\n}\n.footer[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: space-between;\n  gap: 1rem;\n  flex-wrap: wrap;\n  padding: 1.25rem clamp(1rem, 4vw, 2.5rem);\n  border-top: 1px solid var(--line);\n  color: var(--muted);\n  font-size: 0.9rem;\n}\n@media (min-width: 960px) {\n  .nav[_ngcontent-%COMP%] {\n    display: flex;\n  }\n  .menu-toggle[_ngcontent-%COMP%], \n   .mobile-nav[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n/*# sourceMappingURL=shell.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ShellComponent, [{
    type: Component,
    args: [{ selector: "app-shell", imports: [RouterOutlet, RouterLink, RouterLinkActive, Button, NgClass], template: `
    <div class="shell">
      <header class="topbar">
  ...
  `, styles: ["/* angular:styles/component:css;c1bf4939b8a6e85e591c04974585a592e5a60e64fea05c7c4ded35e4f7b75044;C:/Projeler/onureakgul.github.io/src/app/layout/shell.component.ts */\n.shell {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n}\n.topbar {\n  position: sticky;\n  top: 0;\n  z-index: 20;\n  display: grid;\n  grid-template-columns: auto 1fr auto;\n  gap: 1rem;\n  align-items: center;\n  padding: 0.9rem clamp(1rem, 4vw, 2.5rem);\n  -webkit-backdrop-filter: blur(14px);\n  backdrop-filter: blur(14px);\n  background: color-mix(in srgb, var(--bg) 82%, transparent);\n  border-bottom: 1px solid var(--line);\n}\n.brand {\n  font-family: var(--font-display);\n  font-weight: 700;\n  font-size: 1.15rem;\n  letter-spacing: -0.02em;\n  color: var(--ink);\n  text-decoration: none;\n}\n.nav {\n  display: none;\n  justify-content: center;\n  gap: 0.35rem;\n  flex-wrap: wrap;\n}\n.nav a {\n  text-decoration: none;\n  color: var(--muted);\n  font-size: 0.92rem;\n  padding: 0.45rem 0.7rem;\n  border-radius: 999px;\n  transition: color 180ms ease, background 180ms ease;\n}\n.nav a:hover,\n.nav a.active {\n  color: var(--ink);\n  background: var(--chip);\n}\n.actions {\n  display: flex;\n  align-items: center;\n  gap: 0.15rem;\n}\n:host ::ng-deep .lang-btn {\n  color: var(--muted) !important;\n  font-weight: 600;\n}\n:host ::ng-deep .active-lang {\n  color: var(--accent) !important;\n}\n.menu-toggle {\n  display: inline-flex;\n  border: 0;\n  background: transparent;\n  color: var(--ink);\n  font-size: 1.2rem;\n  margin-left: 0.35rem;\n  cursor: pointer;\n}\n.mobile-nav {\n  display: flex;\n  flex-direction: column;\n  gap: 0.35rem;\n  padding: 0.75rem 1rem 1rem;\n  border-bottom: 1px solid var(--line);\n  background: var(--bg-elevated);\n}\n.mobile-nav a {\n  text-decoration: none;\n  color: var(--ink);\n  padding: 0.7rem 0.5rem;\n  border-radius: 0.6rem;\n}\n.main {\n  flex: 1;\n  width: min(1120px, calc(100% - 2rem));\n  margin: 0 auto;\n  padding: clamp(1.5rem, 4vw, 3rem) 0 3rem;\n}\n.footer {\n  display: flex;\n  justify-content: space-between;\n  gap: 1rem;\n  flex-wrap: wrap;\n  padding: 1.25rem clamp(1rem, 4vw, 2.5rem);\n  border-top: 1px solid var(--line);\n  color: var(--muted);\n  font-size: 0.9rem;\n}\n@media (min-width: 960px) {\n  .nav {\n    display: flex;\n  }\n  .menu-toggle,\n  .mobile-nav {\n    display: none;\n  }\n}\n/*# sourceMappingURL=shell.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ShellComponent, { className: "ShellComponent", filePath: "src/app/layout/shell.component.ts", lineNumber: 196 });
})();
...
var routes = [
  { path: "", pathMatch: "full", redirectTo: "en" },
  {
    ...
    children: [
      __spreadValues({
        path: "",
        loadComponent: () => import("./chunk-63DCPQEX.js").then((m5) => m5.HomeComponent)
      }, false ? { \u0275entryName: "src/app/pages/home.component.ts" } : {}),
      __spreadValues({
        path: "about",
        loadComponent: () => import("./chunk-KANCQPGI.js").then((m5) => m5.AboutComponent)
      }, false ? { \u0275entryName: "src/app/pages/about.component.ts" } : {}),
      __spreadValues({
        path: "experience",
        loadComponent: () => import("./chunk-TNCH4DNC.js").then((m5) => m5.ExperienceComponent)
      }, false ? { \u0275entryName: "src/app/pages/experience.component.ts" } : {}),
      __spreadValues({
        path: "skills",
        loadComponent: () => import("./chunk-XNZIWECI.js").then((m5) => m5.SkillsComponent)
      }, false ? { \u0275entryName: "src/app/pages/skills.component.ts" } : {}),
      __spreadValues({
        path: "projects",
        loadComponent: () => import("./chunk-2G73U7N7.js").then((m5) => m5.ProjectsComponent)
      }, false ? { \u0275entryName: "src/app/pages/projects.component.ts" } : {}),
      __spreadValues({
        path: "links",
        loadComponent: () => import("./chunk-PQIBSUYF.js").then((m5) => m5.LinksComponent)
      }, false ? { \u0275entryName: "src/app/pages/links.component.ts" } : {}),
      __spreadValues({
        path: "contact",
        loadComponent: () => import("./chunk-6PHKPFSW.js").then((m5) => m5.ContactComponent)
      }, false ? { \u0275entryName: "src/app/pages/contact.component.ts" } : {})
    ]
  },
  { path: "**", redirectTo: "en" }
];
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ selector: "app-root", imports: [RouterOutlet], template: `<router-outlet />`, styles: ["/* angular:styles/component:css;189b4b61fdb5160d2334e130ea0b07376c066e6c4f53324082f9858a80e3631d;C:/Projeler/onureakgul.github.io/src/app/app.ts */\n:host {\n  display: block;\n  min-height: 100vh;\n}\n/*# sourceMappingURL=app.css.map */\n"] }]
  }], null, null);
})();
(() => {
