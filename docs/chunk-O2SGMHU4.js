...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(a2) && n.transform !== "strict") {
    ...
    d2 = `${et}${tt}`, u2 = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g2 = m(a2.css, { dt: E2 });
  }
  ...
  if (s(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m3 = t2, { colorScheme: R2, extend: T, css: j } = m3, O = v2(m3, ["colorScheme", "extend", "css"]), d2 = T || {}, { colorScheme: M } = d2, z3 = v2(d2, ["colorScheme"]), u2 = R2 || {}, { dark: V } = u2, L = v2(u2, ["dark"]), g2 = M || {}, { dark: te } = g2, re2 = v2(g2, ["dark"]), K2 = s(O) ? this._toVariables({ [y3]: h(h({}, O), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y3]: h(h({}, L), re2) }, r) : {}, X2 = s(V) ? this._toVariables({ [y3]: h(h({}, V), te) }, r) : {}, [G2, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B, I] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H, W2] = [(p3 = X2.declarations) != null ? p3 : "", X2.tokens || []], q = this.transformCSS(y3, `${G2}${B}`, "light", "variable", r, i3, a2, n), Z = this.transformCSS(y3, H, "dark", "variable", r, i3, a2, n);
    l3 = `${q}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I, ...W2])], c4 = m(j, { dt: E2 });
  }
...
//# sourceMappingURL=chunk-O2SGMHU4.js.map
